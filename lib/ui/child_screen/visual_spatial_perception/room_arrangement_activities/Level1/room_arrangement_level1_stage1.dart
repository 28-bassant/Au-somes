          ...
          body: LayoutBuilder(
            builder: (context, constraints) {
              ...
              final List<double> placedActorSizes = [
                constraints.maxWidth * 0.18, // Actor 0 بعد السحب
                constraints.maxWidth * 0.22, // Actor 1 بعد السحب
              ];

              // ================= أماكن Drop Zones =================
              List<Offset> dropPositions = [
                Offset(constraints.maxWidth * 0.30, constraints.maxHeight * 0.47),
                Offset(constraints.maxWidth * 0.7, constraints.maxHeight * 0.52),
              ];
