...
class MentalCuttingLevel3Stage2 extends StatefulWidget {
  final VoidCallback? onNextStage;

  const MentalCuttingLevel3Stage2({Key? key, this.onNextStage}) : super(key: key);

  @override
  MentalCuttingLevel3Stage2State createState() => MentalCuttingLevel3Stage2State();
}

class MentalCuttingLevel3Stage2State extends State<MentalCuttingLevel3Stage2>
            ...
            children: [
              ...
              GridView.count(
                ...
                children: anchors.map((anchor) {
                  // البحث عن الـ Actor الذي يستهدف هذا الـ Anchor
