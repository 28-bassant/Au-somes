...
class Activity2Level1Stage1 extends StatefulWidget {
  final VoidCallback? onNextStage;

  const Activity2Level1Stage1({Key? key, this.onNextStage}) : super(key: key);

  @override
  Activity2Level1Stage1State createState() => Activity2Level1Stage1State();
}

class Activity2Level1Stage1State extends State<Activity2Level1Stage1>
      ...
      body: Container(
        ...
        child: LayoutBuilder(
          builder: (context, constraints) {
            ...
            final double leftPositionPercent = 20 / 400;        // 5% من العرض
            ...
            final double correctPosition = constraints.maxWidth * correctPositionPercent;

            final double topRightPosition = constraints.maxHeight * topRightPositionPercent;
