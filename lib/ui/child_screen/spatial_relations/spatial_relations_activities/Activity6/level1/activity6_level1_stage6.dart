...
class Activity6Level1Stage6 extends StatefulWidget {
  final VoidCallback? onNextStage;

  const Activity6Level1Stage6({Key? key, this.onNextStage}) : super(key: key);

  @override
  State<Activity6Level1Stage6> createState() => Activity6Level1Stage6State();
}

class Activity6Level1Stage6State extends State<Activity6Level1Stage6> {
        ...
        return Scaffold(
          body: LayoutBuilder(
            builder: (context, constraints) {
              ...
              final actorSize = shadowSize * 0.28;
              final centerX = screenWidth / 2;
              final centerY = screenHeight / 2;

              final containerWidth = actorSize*.8; // نفس عرض الـ actor
              final containerHeight = actorSize*1.6; // نفس ارتفاع الـ actor أو Shadow لو عايزة أكبر
              ...
              return Stack(
                children: [
                  ...
                  //مكان الاسقاط
                  Positioned(
                    left: centerX - shadowSize / 2+screenWidth*.26,
                    top: centerY - shadowSize / 2+screenHeight*.08,
