...
class Activity6Level1Stage5 extends StatefulWidget {
  final VoidCallback? onNextStage;

  const Activity6Level1Stage5({Key? key, this.onNextStage}) : super(key: key);

  @override
  State<Activity6Level1Stage5> createState() => Activity6Level1Stage5State();
}

class Activity6Level1Stage5State extends State<Activity6Level1Stage5> {
            ...
            builder: (context, constraints) {
              ...
              return Stack(
                children: [
                  ...
                  //مكان الاسقاط
                  Positioned(
                    right: centerX - shadowSize / 2+screenWidth*.01,
