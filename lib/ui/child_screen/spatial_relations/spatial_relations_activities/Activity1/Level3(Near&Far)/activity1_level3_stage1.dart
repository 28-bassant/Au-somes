...
class Activity1Level3Stage1 extends StatefulWidget {
  final VoidCallback? onNextStage;

  const Activity1Level3Stage1({Key? key, this.onNextStage}) : super(key: key);

  @override
  Activity1Level3Stage1State createState() => Activity1Level3Stage1State();
}

class Activity1Level3Stage1State extends State<Activity1Level3Stage1>
      ...
      body: Container(
        ...
        child: LayoutBuilder(
          builder: (context, constraints) {
            ...
            final double correctOptionWidthPercent = 80 / 400;  // 20% من العرض المرجعي
            final double wrongOptionWidthPercent = 60 / 400;    // 15% من العرض المرجعي

            // نسب المواقع من الكود الأصلي
            final double rightWrongPositionPercent = 40 / 400;     // 10% من العرض
            final double rightCorrectPositionPercent = 80 / 400;   // 20% من العرض
            final double topWrongPositionPercent = 100 / 800;      // 12.5% من الارتفاع
            final double topCorrectPositionPercent = 400 / 800;    // 50% من الارتفاع
