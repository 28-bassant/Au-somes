...
class Activity4Level1Stage2 extends StatefulWidget {
  final VoidCallback? onNextStage;

  const Activity4Level1Stage2({Key? key, this.onNextStage}) : super(key: key);

  @override
  Activity4Level1Stage2State createState() => Activity4Level1Stage2State();
}

class Activity4Level1Stage2State extends State<Activity4Level1Stage2>
