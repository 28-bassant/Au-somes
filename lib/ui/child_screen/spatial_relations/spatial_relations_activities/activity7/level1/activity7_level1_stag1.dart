        ...
        builder: (context, constraints) {
          ...
          return Stack(
            children: [
                ...
                child: !isPlacedCorrectly
                  ...
                  onAccept: (data) {
                    if (data == actor.targetedZoneId) {
                      ...
                      WellDoneOverlay.show(context, duration: const Duration(seconds: 2));
                      Future.delayed(const Duration(seconds: 2), () {
              ...
              if (isPlacedCorrectly)
                Positioned(
                  right: screenWidth * 0.08 + basketSize * 0.20,
                  top: basketTop + basketSize * 0.40,
                  child: Image.network(
                    actor.imageUrl ?? '',
                    width: ballSize * 0.57,
                  ),
