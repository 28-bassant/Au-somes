...
class RightLeftLevel4Stage1 extends StatefulWidget {
  final VoidCallback? onNextStage;

  const RightLeftLevel4Stage1({Key? key, this.onNextStage}) : super(key: key);

  @override
  State<RightLeftLevel4Stage1> createState() => RightLeftLevel4Stage1State();
}

class RightLeftLevel4Stage1State extends State<RightLeftLevel4Stage1>
