...
class NearFarLevel4Stage2 extends StatefulWidget {
  final VoidCallback? onNextStage;

  const NearFarLevel4Stage2({
    Key? key,
    this.onNextStage,
  }) : super(key: key);

  @override
  NearFarLevel4Stage2State createState() => NearFarLevel4Stage2State();
}

class NearFarLevel4Stage2State extends State<NearFarLevel4Stage2>
