...
class NearFarLevel4Stage4 extends StatefulWidget {
  final VoidCallback? onNextStage;

  const NearFarLevel4Stage4({
    Key? key,
    this.onNextStage,
  }) : super(key: key);

  @override
  NearFarLevel4Stage4State createState() => NearFarLevel4Stage4State();
}

class NearFarLevel4Stage4State extends State<NearFarLevel4Stage4>
        ...
        Positioned(
          ...
          child: DragTarget<String>(
            ...
            builder: (context, candidateData, rejectedData) {
              return Image.network(shadow.imageUrl ?? '', width: shadowWidth);
            },
          ),
        ),
              ...
              builder: (context, candidateData, rejectedData) {
                return isPlacedCorrectly
                  ...
                  child: Image.network(actor.imageUrl ?? '',
                    ...
                    : Image.network(shadow.imageUrl ?? '', width: shadowWidth);
              },
            ),
          ),
        ),
