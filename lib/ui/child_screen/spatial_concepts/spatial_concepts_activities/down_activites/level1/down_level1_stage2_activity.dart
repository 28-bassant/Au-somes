...
class DownLevel1Stage2Activity extends StatefulWidget {
  final VoidCallback? onNextStage;

  const DownLevel1Stage2Activity({Key? key, this.onNextStage}) : super(key: key);

  @override
  DownLevel1Stage2ActivityState createState() => DownLevel1Stage2ActivityState();
}

class DownLevel1Stage2ActivityState extends State<DownLevel1Stage2Activity> {
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        /// 🪑 حجم الكرسي
        final anchorWidth = screenWidth * 2.9;
        final anchorHeight = screenHeight * 0.82;

        /// مكان بداية الكرسي من فوق
        final anchorTop = screenHeight * 0.01;

        /// حجم القطة
        final actorSize = anchorWidth * 0.17;
        ...
        final actorLeft = (screenWidth - actorSize) / 2 -36;

        // موقع وحجم الكونتينر الشفاف على القطة
        final containerLeft = width * 0.29;
        final containerTop = height * 0.41;
