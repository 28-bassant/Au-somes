...
class BetweenLevel1Stage4ActivityState extends State<BetweenLevel1Stage4Activity>
  ...
  Widget build(BuildContext context) {
    ...
    if (activity == null || activity!.elements!.isEmpty) {
      return const Center(child: Text('Error loading activity'));
    }

    final actorElement =
    activity!.elements!.firstWhere((e) => e.role == 'Actor');
    final wrongActorElement =
    activity!.elements!.lastWhere((e) => e.role == 'Actor');
    final anchorElement =
    ...
    return LayoutBuilder(
      ...
      // موقع الأكتور الصح
      final actorOffset =
      Offset((screenWidth - actorWidth) / 2, screenHeight * 0.20);
