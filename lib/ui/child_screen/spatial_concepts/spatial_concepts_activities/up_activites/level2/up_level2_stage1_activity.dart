...
class UpLevel2Stage1Activity extends StatefulWidget {
  ...
  const UpLevel2Stage1Activity({Key? key, this.onNextStage}) : super(key: key);

  @override
  State<UpLevel2Stage1Activity> createState() => UpLevel2Stage1ActivityState();
}

class UpLevel2Stage1ActivityState extends State<UpLevel2Stage1Activity>
