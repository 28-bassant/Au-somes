...
class UpLevel2Stage4Activity extends StatefulWidget {
  ...
  const UpLevel2Stage4Activity({
    Key? key,
    this.onNextStage,
  }) : super(key: key);

  @override
  State<UpLevel2Stage4Activity> createState() =>
      UpLevel2Stage4ActivityState();
}

class UpLevel2Stage4ActivityState
    extends State<UpLevel2Stage4Activity> {
...
// 🪑 حجم الطرابيزة
    ...
    return Stack(
      children: [
        ...
        Positioned(
          left: 100,
          top: 194, // موقع الـ Shadow الأصلي
          child: Container(
            key: _shadow1Key,
            width: 240,
            height: 240,
