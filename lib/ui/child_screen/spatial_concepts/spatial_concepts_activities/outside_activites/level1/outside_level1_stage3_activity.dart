...
class OutsideLevel1Stage3Activity extends StatefulWidget {
  final VoidCallback? onNextStage;

  const OutsideLevel1Stage3Activity({Key? key, this.onNextStage}) : super(key: key);

  @override
  OutsideLevel1Stage3ActivityState createState() =>
      OutsideLevel1Stage3ActivityState();
}

class OutsideLevel1Stage3ActivityState extends State<OutsideLevel1Stage3Activity>
