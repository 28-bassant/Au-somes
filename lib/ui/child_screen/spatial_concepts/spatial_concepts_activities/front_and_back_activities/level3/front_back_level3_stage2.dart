...
class FrontBackLevel3Stage2Activity extends StatefulWidget {
  final VoidCallback? onNextStage;
  const FrontBackLevel3Stage2Activity({Key? key, this.onNextStage})
      : super(key: key);

  @override
  State<FrontBackLevel3Stage2Activity> createState() =>
      FrontBackLevel3Stage2ActivityState();
}

class FrontBackLevel3Stage2ActivityState
    extends State<FrontBackLevel3Stage2Activity>
